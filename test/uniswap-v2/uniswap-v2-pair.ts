...
const MINIMUM_LIQUIDITY = scale(1, 3);
...
describe("UniswapV2Pair", () => {
  ...
  before(async () => {
    ...
    const Pair = await getSkittlesFactory(wallet, "UniswapV2Pair");
  ...
  //   // TODO Need to change the deployment to be via the factory for this to work
  //   it("feeTo:on", async () => {
